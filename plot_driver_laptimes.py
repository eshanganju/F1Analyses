...
race = fastf1.get_session(2025, "Vegas", 'R')
race.load()
...
DRI1 = "HAM"
DRI2 = "VER"
driver_laps1 = race.laps.pick_drivers(DRI1).pick_quicklaps().reset_index()
driver_laps2 = race.laps.pick_drivers(DRI2).pick_quicklaps().reset_index()
...
sns.scatterplot(data=driver_laps1,
                x="LapNumber",
                y="LapTime",
                ax=ax,
                hue="Compound",
...
sns.scatterplot(data=driver_laps2,
                x="LapNumber",
                y="LapTime",
                ax=ax,
                hue="Compound",
...
ax.invert_yaxis()
plt.suptitle(DRI1 + " vs " + DRI2 +  " Laptimes in the 2023 Azerbaijan Grand Prix")
